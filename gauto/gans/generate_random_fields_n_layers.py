...
if __name__ == "__main__":
    ...
    y_coord = np.linspace(1, dim, dim, dtype=int)
    ...
    for counter_s, seed in enumerate(range(101010, 101110, 10)):
        print(counter_s)
        random.seed(seed)
        ...
        layers = [srf_clay, srf_silt, srf_silt, srf_clay, srf_sand, srf_clay, srf_sand]
        n_layers = 7
        ...
        with open(
            f"data\\RF_3d_{counter_s}.csv", "w", encoding="ISO-8859-1", newline=""
        ) as myfile:
