...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_name", choices=["letter", "spam"], default="spam", type=str
    )
    parser.add_argument(
        "--miss_rate", help="missing data probability", default=0.5, type=float
    )
    parser.add_argument(
        "--batch_size",
    ...
    parser.add_argument(
        "--iterations", help="number of training interations", default=600, type=int
    )

    args = parser.parse_args()
    args.data_name = "synthetic_data_G2"
    args.batch_size = 5
    # Calls main function
